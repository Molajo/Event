 ...
 */
namespace Molajo\Event\Plugins\Catalog;
...
class CatalogPlugin extends Plugin
{
    ...
    public function onBeforeInclude()
    {
        ...
        $application_home_catalog_id =
            (int) $this->application_instance->get('application_home_catalog_id');
    ...
    public function onAfterCreate()
    {
        ...
        if ($this->application_instance->get('log_user_update_activity', 1) == 1) {
        ...
        if ($this->application_instance->get('log_catalog_update_activity', 1) == 1) {
